    ...
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="nivo-glass-surface border border-zinc-800 rounded-3xl p-4">
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full nivo-glass-surface border border-zinc-800 rounded-xl pl-10 pr-4 py-2.5 text-white text-xs focus:outline-none focus:border-[#00C9A7]"
          />
        </div>
      </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-zinc-800/60 font-medium text-zinc-300">
                {filteredUsers.map((u) => (
                  <tr key={u.id} className="hover:bg-[#071114] transition-colors">
      ...
      {adjustModalOpen && selectedUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="nivo-glass-surface border border-[#00C9A7]/30 rounded-3xl w-full max-w-md p-6 space-y-4">
            ...
            <form onSubmit={handleAdjustSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full nivo-glass-surface border border-zinc-800 rounded-xl px-4 py-3 text-white text-sm font-bold focus:outline-none focus:border-[#00C9A7]"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full nivo-glass-surface border border-zinc-800 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#00C9A7]"
                />
              </div>
