              ...
              <tbody className="divide-y divide-zinc-800/60 font-medium text-zinc-300">
                {filteredUsers.map((u) => (
                  <tr key={u.id} className="hover:bg-[#171b26] transition-colors">
                    ...
                    <td className="py-3 px-3 font-mono font-bold text-orange-400">{u.referralCode}</td>
                    ...
                    <td className="py-3 px-3 text-right space-x-2">
                      <button
                        ...
                        className="bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 border border-amber-500/30 text-[10px] font-bold px-2.5 py-1 rounded-lg transition-all cursor-pointer"
                      >
                        Adjust Balance
                      </button>
