    ...
    <div className="w-full max-w-4xl mx-auto space-y-6 pb-12 animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-[#240A12] via-[#16090D] to-[#16090D] border border-[#8F1D3A]/20 rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="bg-[#16090D]/80 border border-zinc-800 p-4 rounded-2xl flex items-center gap-3 w-full md:w-auto shrink-0">
            {isFullyUnlocked ? (
              <div className="flex items-center gap-3 text-[#A52A4A]">
      ...
      {currentRefs < 5 && (
        <div className="nivo-glass-surface border border-zinc-800 rounded-3xl p-6 sm:p-8 text-center space-y-6 shadow-xl">
          ...
          <Link
            to="/referrals"
            className="inline-flex items-center justify-center gap-2 bg-[#8F1D3A] hover:bg-[#7A1831] text-black font-extrabold text-xs px-8 py-4 rounded-2xl shadow-xl shadow-[#8F1D3A]/20 transition-all cursor-pointer"
          >
      ...
      {isFullyUnlocked && (
        <div className="bg-[#240A12]/20 border border-[#8F1D3A]/30 rounded-3xl p-6 sm:p-8 text-center space-y-5 shadow-xl">
          <div className="w-20 h-20 rounded-full bg-[#8F1D3A]/20 text-[#A52A4A] border border-[#8F1D3A]/30 flex items-center justify-center mx-auto text-2xl font-bold shadow-2xl">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-[#8F1D3A] hover:bg-[#A52A4A] text-black font-black text-xs px-8 py-3.5 rounded-2xl shadow-xl transition-all cursor-pointer"
          >
